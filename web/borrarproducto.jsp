    ...
    <body>
        ...
        <div class="row">
          ...
          <div class="imput-field col s12 m12 l9">
              ...
              <div class="row">
                  <form class="col s12" action="borrarproducto.do">
                        
                        <div class="row">
                            <div class="input-field col s8">
                                <input readonly id="ntxtID" name="prontxtID" type="text" class="validate" value=<% out.print(pro.getIdProducto()); %>>
                                <label for="prtxtID">ID PRODUCTO</label>
                            </div>
                        </div>   
                        
                      <div class="row">
                        <div class="input-field col s8">
                          <input readonly id="first_name" name="prtxtnombre" type="text" class="validate" value=<% out.print(pro.getNombre()); %>>
                      ...
                      <div class="row">
                        <div class="input-field col s8">
                            <input readonly id="first_name" name="prtxtdetalle" type="text" class="validate" value=<% out.print(pro.getDetalle()); %>>
                          <label for="disabled">DETALLE PRODUCTO</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s8">
                            <input readonly id="first_name" name="prtxtprecio" type="text" class="validate" value=<% out.print(pro.getPrecio()); %>>
                          <label for="disabled">PRECIO PRODUCTO</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s8">
                            <input readonly id="first_name" name="prtxtcantidad" type="text" class="validate" value=<% out.print(pro.getCantidad()); %>>
                          <label for="disabled">CANTIDAD PRODUCTO</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s8">
                            <input readonly id="first_name" name="prtxtcategoria" type="text" class="validate" value=<% out.print(pro.getCategoria()); %>>
