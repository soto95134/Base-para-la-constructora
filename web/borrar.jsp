...
<% CategoriaModel cat = (CategoriaModel)request.getAttribute("categoria"); %>
<!DOCTYPE html>
  <html>
    <head>
    ...
    <body>
        ...
        <div class="row">
          ...
          <div class="imput-field col s12 m12 l9">
              ...
              <div class="row">
                  <form class="col s12" action="borrarcategoria.do">
                        
                        <div class="row">
                            <div class="input-field col s8">
                                <input readonly id="ntxtID" name="ntxtID" type="text" class="validate" value=<% out.print(cat.getIdCategoria()); %>>
                      ...
                      <div class="row">
                        <div class="input-field col s8">
                          <input readonly id="first_name" name="ncategoria" type="text" class="validate" value=<% out.print(cat.getNombre()); %>>
                      ...
                      <div class="row">
                        <div class="input-field col s8">
                            <input readonly id="first_name" name="ndetalle" type="text" class="validate" value=<% out.print(cat.getDetalle()); %>>
                          <label for="disabled">DETALLE CATEGORIA</label>
                        </div>
                      </div>
                                          <div class="row">
