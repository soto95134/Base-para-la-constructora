                    ...
                    <form class="col s12" action="">
                      <div class="row">
                        <div class="input-field col s8">
                            <input  readonly id="first_name" type="text" class="validate" value="<% out.print(cat.getNombre()); %>">
                      ...
                      <div class="row">
                        <div class="input-field col s8">
                            <input readonly placeholder="Placeholder" id="first_name" type="text" class="validate" value="<% out.print(cat.getDetalle()); %>">
