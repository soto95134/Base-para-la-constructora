                    ...
                    <form class="col s12" action="editarcategoria.do" method="POST">
                        ...
                        <div class="row">
                            <div class="input-field col s8">
                                <input readonly id="txtID" name="txtID" type="text" class="validate" value="<% out.print(cat.getIdCategoria()); %>">
                        ...
                        <div class="row">
                            <div class="input-field col s8">
                                <input  placeholder="Placeholder" name="txtnombre" type="text" class="validate" value="<% out.print(cat.getNombre()); %>">
                        ...
                        <div class="row">
                            <div class="input-field col s8">
                                <input placeholder="Placeholder" name="txtdetalle" type="text" class="validate" value="<% out.print(cat.getDetalle()); %>">
